...
public class ScheduledJobs {
	...
	public synchronized void updateTrainingToNotCompleted() {
		...
		trainingStatus.add(Constants.TrainingStatus.PROPOSED.getStatus());
		trainingStatus.add(Constants.TrainingStatus.CONFIRMED.getStatus());
		trainingStatus.add(Constants.TrainingStatus.TRAINING_STARTED.getStatus());
