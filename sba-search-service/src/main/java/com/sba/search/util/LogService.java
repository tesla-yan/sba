...
public class LogService {
	...
	/**
	 * "Before" advice in the method beforeMethodStatistics in order to get time
	 * in milliseconds just before the method execution occurs. It calls
	 * JointPoint as a parameter to capture the parameters passed in the method
	 * execution.
	 * 
	 * @param jp
	 * @throws Throwable
