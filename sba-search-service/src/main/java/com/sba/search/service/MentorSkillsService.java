...
import com.sba.search.client.SkillServiceFeignClient;
import com.sba.search.client.TrainingServiceFeignClient;
import com.sba.search.client.UserServiceFeignClient;
import com.sba.search.entity.MentorSkills;
import com.sba.search.exception.ResourceExistException;
import com.sba.search.exception.ResourceNotFoundException;
import com.sba.search.exception.ServiceUnavailableException;
import com.sba.search.model.MentorSkillsDtls;
import com.sba.search.model.SkillDtls;
import com.sba.search.model.TrainingDtls;
import com.sba.search.model.UserDtls;
import com.sba.search.repo.MentorSkillsRepository;
...
public class MentorSkillsService {
	...
	@Autowired
	private TrainingServiceFeignClient trainingProxy;
