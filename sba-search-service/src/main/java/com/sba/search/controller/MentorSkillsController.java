...
import com.sba.search.entity.MentorSkills;
import com.sba.search.exception.PaginationSortingException;
import com.sba.search.model.MentorSkillsDtls;
import com.sba.search.pagination.Direction;
import com.sba.search.pagination.OrderBy;
import com.sba.search.service.MentorSkillsService;
...
public class MentorSkillsController {
	...
	@ApiOperation(value = "View list of technology available within date-time range", response = Page.class)
	@ApiResponses(value = {
	...
	@ApiOperation(value = "Add mentor skill details", response = com.sba.security.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
	...
	public com.sba.security.model.ApiResponse<?> addMentorSkill(
			@ApiParam(value = "Mentor Skill details which needs to add", required = true) @Valid @RequestBody MentorSkills mentorSkill) {

		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.add"),
				mentorSkillService.addMentorSkill(mentorSkill));

	}

	@ApiOperation(value = "Update mentor skill details", response = com.sba.security.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.sba.security.model.ApiResponse<?> updateMentorSkill(
			@ApiParam(value = "Mentor Skill details which needs to update", required = true) @Valid @RequestBody MentorSkills mentorSkill) {

		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.update"),
	...
	public com.sba.security.model.ApiResponse<?> updateMentorTrainingCount(
		...
		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), null,
				mentorSkillService.updateMentorTrainingCount(mentorId, skillId));

	}

	@ApiOperation(value = "Delete mentor skill details", response = com.sba.security.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.sba.security.model.ApiResponse<?> deleteMentorSkill(
		...
		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.delete"));
