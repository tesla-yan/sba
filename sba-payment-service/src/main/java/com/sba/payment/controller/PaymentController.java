...
import com.sba.payment.exception.PaginationSortingException;
import com.sba.payment.model.PaymentDtls;
import com.sba.payment.pagination.Direction;
import com.sba.payment.pagination.OrderBy;
...
public class PaymentController {
	...
	@ApiOperation(value = "Add payment details", response = ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	})
	@PostMapping("/addPayment")
	public com.sba.security.model.ApiResponse<?> addPayment(
			@ApiParam(value = "Payment object which needs to add", required = true) @Valid @RequestBody Payment payment) {

		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.payment.add"),
   ...
   */
	...
	@ApiOperation(value = "Update payment commission details", response = ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.sba.security.model.ApiResponse<?> updatePayment(
		...
		return new com.sba.security.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.payment.commission.update"),
