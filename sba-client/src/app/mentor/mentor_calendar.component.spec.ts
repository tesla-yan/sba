...
describe('MentorCalendarComponent', () => {
    ...
    it('Mentor Id is null ',()=>{
      ...
      it('displayEvent is null ',()=>{
        const app = fixture.debugElement.componentInstance;
        expect(app.displayEvent).toBeNull;
      });

      it('calendarEvent is null ',()=>{
        const app = fixture.debugElement.componentInstance;
        expect(app.calendarEvent).toBeNull;
      });
      it('calendarOptions is null ',()=>{
        const app = fixture.debugElement.componentInstance;
        expect(app.calendarOptions).toBeNull;
      });
